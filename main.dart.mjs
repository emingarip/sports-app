...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1552: (x0,x1) => new WebSocket(x0,x1),
      _1553: (x0,x1) => x0.send(x1),
      _1554: (x0,x1,x2) => x0.close(x1,x2),
      _1555: (x0,x1) => x0.close(x1),
      _1556: x0 => x0.close(),
      _1557: () => new AbortController(),
      _1558: x0 => x0.abort(),
      _1559: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1560: (x0,x1) => globalThis.fetch(x0,x1),
      ...
      _1564: x0 => x0.getReader(),
      _1565: x0 => x0.cancel(),
      _1566: x0 => x0.read(),
      _1567: x0 => new BroadcastChannel(x0),
      ...
      _1611: (t, s) => t.set(s),
      _1612: l => new DataView(new ArrayBuffer(l)),
      ...
      _1677: (x0,x1) => { x0.pointerEvents = x1 },
      _1686: x0 => x0.style,
      _1689: x0 => x0.src,
      _1690: (x0,x1) => { x0.src = x1 },
      _1691: x0 => x0.naturalWidth,
      _1692: x0 => x0.naturalHeight,
      _1708: x0 => x0.status,
      _1709: (x0,x1) => { x0.responseType = x1 },
